...
public enum JVMInstr {
    ...
    BIPUSH(0x10, 1, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.VOID, true),
    ...
    DDIV(0x6f, 0, new StackTypes(StackType.DOUBLE, StackType.DOUBLE), StackType.DOUBLE.asList(), RawJavaType.DOUBLE, true),
    ...
    DMUL(0x6b, 0, new StackTypes(StackType.DOUBLE, StackType.DOUBLE), StackType.DOUBLE.asList(), RawJavaType.DOUBLE, true),
    DNEG(0x77, 0, StackType.DOUBLE.asList(), StackType.DOUBLE.asList(), RawJavaType.DOUBLE,true),
    DREM(0x73, 0, new StackTypes(StackType.DOUBLE, StackType.DOUBLE), StackType.DOUBLE.asList(), RawJavaType.DOUBLE, true),
    ...
    I2S(0x93, 0, StackType.INT.asList(), StackType.INT.asList(), RawJavaType.SHORT, true),
    IADD(0x60, 0, new StackTypes(StackType.INT, StackType.INT), StackType.INT.asList(), RawJavaType.INT, true),
    IALOAD(0x2E, 0, new StackTypes(StackType.REF, StackType.INT), StackType.INT.asList(), RawJavaType.INT),
    IAND(0x7E, 0, new StackTypes(StackType.INT, StackType.INT), StackType.INT.asList(), RawJavaType.INT, true),
    ...
    INEG(0x74, 0, StackType.INT.asList(), StackType.INT.asList(), RawJavaType.INT, true),
    ...
    IOR(0x80, 0, new StackTypes(StackType.INT, StackType.INT), StackType.INT.asList(), RawJavaType.INT, true),
    ...
    ISHL(0x78, 0, new StackTypes(StackType.INT, StackType.INT), StackType.INT.asList(), RawJavaType.INT, true),
    ISHR(0x7a, 0, new StackTypes(StackType.INT, StackType.INT), StackType.INT.asList(), RawJavaType.INT, true),
    ...
    SIPUSH(0x11, 2, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.SHORT, true),
