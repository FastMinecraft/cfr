...
public class InfiniteAssertRewriter implements StructuredStatementTransformer {
    ...
    public InfiniteAssertRewriter(StaticVariable assertionStatic) {
        ...
        thrw = new StructuredThrow(
            BytecodeLoc.NONE,
            wcm1.getConstructorSimpleWildcard("ignore", TypeConstants.ASSERTION_ERROR)
        );
    }
    ...
    private void replaceThrow(
        Op04StructuredStatement thrw,
        ...
        bodyBlock.addStatement(new Op04StructuredStatement(
            new StructuredIf(
                BytecodeLoc.TODO,
                new NotOperation(BytecodeLoc.TODO, cond),
                new Op04StructuredStatement(new Block(new Op04StructuredStatement(throwInner)))
            )));
        thrw.nopOut();
    }
